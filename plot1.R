### Code used the package 'lubridate'. Please install before running code
library(lubridate)
...
### Code block for creating PNG file and plotting histogram

png(filename="plot1.png", width=480, height=480)
with(dt1, hist(Global_active_power, xlab ="Global Active Power (kilowatts)", main="Global Active Power", col="red"))
dev.off()
